...
function FileTreeNode({ node, level }: FileTreeNodeProps) {
  ...
  return (
    <div>
      <div
        className={cn(
          "flex items-center gap-2 px-2 py-1.5 hover:bg-accent cursor-pointer text-sm transition-colors text-foreground/80",
          selectedFile === node.path && "bg-sky-500/10 text-sky-500"
        )}
