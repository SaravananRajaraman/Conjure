  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-500/15 to-sky-500/15 mb-4 shadow-sm">
          <Bot className="h-7 w-7 text-sky-500" />
        </div>
        <p className="text-foreground font-semibold text-lg mb-2">Describe a component to get started</p>
        <p className="text-muted-foreground text-sm max-w-sm">I can build buttons, forms, cards, dashboards and more</p>
      </div>
    );
  }
      ...
      <div className="space-y-6 max-w-4xl mx-auto w-full">
        {messages.map((message) => (
          ...
          >
            ...
            {message.role === "user" && (
              <div className="flex-shrink-0">
                <div className="w-9 h-9 rounded-lg bg-sky-600 shadow-sm flex items-center justify-center">
